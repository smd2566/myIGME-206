    ...
    public partial class LinkedList : Form
    {
       ...
       */
        ...
        private void Button4__Click(object sender, EventArgs e)
        {
            ...
            // 4. Your code here
            linkedListNode = linkedList.FindLast("I'm");
            if ((string)linkedListNode.Value == null)
            {
                // "sad" is not found
            }
            else
            ...
            linkedListNode = linkedList.FindLast("like");
            if ((string)linkedListNode.Value == null)
            {
                // "sadness" is not found
            }
            else
            {
                if ((string)linkedListNode.Next.Value == "sadness")
                {
                    linkedList.Remove(linkedListNode.Next);
        ...
        private void Button5__Click(object sender, EventArgs e)
        {
            ...
            // 4. Your code here
            linkedListNode1 = linkedList.First;
            linkedListNode2 = linkedList.Find("rain");
            LinkedListNode<object> current = linkedListNode1.Next;
            linkedList.Remove(linkedListNode1.Next);
            ...
            linkedList.Remove(linkedListNode1.Next);
            linkedList.AddAfter(linkedListNode1, current);

            linkedListNode1 = linkedListNode1.Next;
            linkedListNode1 = linkedListNode1.Next;

            linkedListNode2 = linkedList.Find("mainly");
            current = linkedListNode1.Next;
            linkedList.Remove(linkedListNode1.Next);
            linkedList.AddAfter(linkedListNode1, linkedListNode2);
        ...
        private void Button6__Click(object sender, EventArgs e)
        {
            ...
            anagram.Remove(linkedListNode1.Next);
            anagram.AddAfter(linkedListNode1, m);
