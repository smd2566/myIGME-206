...
namespace NumberSort
{
    ...
    //Purpose: Program: Takes a user entered sentence and returns the sentence with the words in either ascending or descending order
    //Restrictions: None
    class Program
    {
        ...
        //Author: David Schuh / Shane Doherty
        //Purpose: Main: Asks the user for a sentence, and uses array logic to sort the sentence's words in ascending or descending order based on user choice
        //Restrictions: None
